...
public:
    ...
    void setupUi(QMainWindow *MainForm)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/icons/pointpol.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPoint_Polygon->setIcon(icon2);
        actionClear_data = new QAction(MainForm);
        actionClear_data->setObjectName("actionClear_data");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/icons/clear.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/images/icons/winding.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/images/icons/ray.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRay_Crossing->setIcon(icon5);
        actionClear_all = new QAction(MainForm);
        actionClear_all->setObjectName("actionClear_all");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/icons/clear_all.png"), QSize(), QIcon::Normal, QIcon::Off);
